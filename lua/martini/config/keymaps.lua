...
-- Terminal vertical (lado a lado) — abre terminal em split vertical,
-- sempre com um NOVO processo de shell (não reaproveita buffer
-- existente). Usa <leader>vs (não <leader>tv) para não colidir com
-- o prefixo de <leader>t, que já é um atalho completo por si só —
-- essa colisão fazia o Neovim disparar <leader>t sozinho e mandar
-- o "v" como texto literal pro shell recém-aberto.
